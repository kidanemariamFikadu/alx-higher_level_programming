...
class TestRectangleMethods(unittest.TestCase):
    ...
    def test_str(self):
        ...
        with patch('syr_out.getvalue(), res)
    ...
    def test_load_from_file_2(self):
        ...
        for i in range(len(linput)):
            self.assertEqual(linput[i].__str__(), loutput[i].__str__())s.stdout', new=StringIO()) as str_out:
            print(r1)
            self.assertEqual(str_out.getvalue(), res)
    ...
    def test_str_3(self):
        ...
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
            self.assertEqual(stqual(str_out.getvalue(), res.replace("'", "\""))
